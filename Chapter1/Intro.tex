...
% radial order of the mode, indicating the number of radial nodes;  is the degree, indi-
...
% have  ≥ 1. Spherically symmetric stars have degenerate pulsation frequencies, in
% that all modes with the same (n, ) have the same frequency, regardless of m. Rotation
