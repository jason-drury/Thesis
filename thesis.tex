...
\usepackage{textcomp}
\usepackage{gensymb}
% \usepackage{lscape} %For superlongsidewaystables use landscape

\usepackage[capitalise,nameinlink]{cleveref}   %References to Sections with fancy symbol
...
\newcommand{\Teffsol}{$T_{\mathrm{eff},\odot}$}
...
\newcommand\citeowners[1]{\citeauthor{#1}'s\ (\citeyear{#1})}

\usepackage{pstricks}
\usepackage{psvectorian}
\usepackage{calligra}
\usepackage{titlepage_sydney_uni}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\clearpage
\appendix
\input{Chapter_Appended/AppendixA} % filename in curly brackets
% \input{Chapter_Appended/AppendixB} % filename in curly brackets
